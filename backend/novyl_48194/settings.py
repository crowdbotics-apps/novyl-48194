"""
Django settings for novyl_48194 project.
...
WSGI_APPLICATION = 'novyl_48194.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "novyl_48194 API",
    "DESCRIPTION": "API documentation for novyl_48194 App",
    "VERSION": "v1",
}
